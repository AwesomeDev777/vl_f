...
import triggerBrowserReflow from '../_utilities/triggerBrowserReflow'
...
const fadeStyles: {
	[key in FadeTransitionStatus]: string
} = {
	[ENTERING]: 'show',
	[ENTERED]: 'show',
}

type FadeTransitionStatus = typeof ENTERING | typeof ENTERED
				...
				{(status: TransitionStatus, innerProps: Record<string, unknown>) =>
					React.cloneElement(children as React.ReactElement, {
						...
						className: classNames(
							...
							fadeStyles[status as FadeTransitionStatus],
